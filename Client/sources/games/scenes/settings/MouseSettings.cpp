...
void rtype::MouseSettings::updateMouse()
{
    std::map<std::string, int> params = {
        {"Sensitivity", this->_containerSettings.getMouseSettings().sensitivity},
        {"Invert y", this->_containerSettings.getMouseSettings().invert_y},
        {"Invert x", this->_containerSettings.getMouseSettings().invert_x},
        {"Mouse acceleration", this->_containerSettings.getMouseSettings().mouse_acceleration},
        {"Mouse acceleration x", this->_containerSettings.getMouseSettings().mouse_acceleration_x},
        {"Mouse acceleration y", this->_containerSettings.getMouseSettings().mouse_acceleration_y},
        {"Mouse filtering", this->_containerSettings.getMouseSettings().mouse_filtering},
        {"Mouse filtering x", this->_containerSettings.getMouseSettings().mouse_filtering_x},
        {"Mouse filtering y", this->_containerSettings.getMouseSettings().mouse_filtering_y},
        {"Mouse smoothing", this->_containerSettings.getMouseSettings().mouse_smoothing},
        {"Mouse smoothing x", this->_containerSettings.getMouseSettings().mouse_smoothing_x},
        {"Mouse smoothing y", this->_containerSettings.getMouseSettings().mouse_smoothing_y},
    };
...
void rtype::MouseSettings::update(float deltatime, float getTime)
{
    SetExitKey(0);
    ...
    if (this->_isSaving == false) {
        ...
        UpdateCoche(_coches, _cochesBool, "mousesettings", this->_containerSettings);
        UpdateJaugeBar(_jaugeBars, _jaugeBarsLevel, "mousesettings", this->_containerSettings, this->soundManager);
